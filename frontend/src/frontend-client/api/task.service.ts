...
// @ts-ignore
import { MigrateTaskToDailyLogInputBody } from '../model/migrateTaskToDailyLogInputBody';
// @ts-ignore
import { MigrateTaskToMonthlyLogInputBody } from '../model/migrateTaskToMonthlyLogInputBody';
// @ts-ignore
import { MigrateTaskToWeeklyLogInputBody } from '../model/migrateTaskToWeeklyLogInputBody';
// @ts-ignore
...
export class TaskService {
     ...
     */
    public cancelTask(id: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public cancelTask(id: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public cancelTask(id: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public cancelTask(id: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
    ...
    /**
     * @param id ID of the task entry
     * @param migrateTaskToDailyLogInputBody 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public migrateTaskToDailyLog(id: number, migrateTaskToDailyLogInputBody: MigrateTaskToDailyLogInputBody, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public migrateTaskToDailyLog(id: number, migrateTaskToDailyLogInputBody: MigrateTaskToDailyLogInputBody, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public migrateTaskToDailyLog(id: number, migrateTaskToDailyLogInputBody: MigrateTaskToDailyLogInputBody, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public migrateTaskToDailyLog(id: number, migrateTaskToDailyLogInputBody: MigrateTaskToDailyLogInputBody, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling migrateTaskToDailyLog.');
        }
        if (migrateTaskToDailyLogInputBody === null || migrateTaskToDailyLogInputBody === undefined) {
            throw new Error('Required parameter migrateTaskToDailyLogInputBody was null or undefined when calling migrateTaskToDailyLog.');
        }
        ...
        let localVarPath = `/api/tasks/${this.configuration.encodeParam({name: "id", value: id, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64"})}/migrateToDaily`;
        return this.httpClient.request<any>('patch', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: migrateTaskToDailyLogInputBody,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: localVarHeaders,
                observe: observe,
    ...
    /**
     * @param id ID of the task entry
     * @param migrateTaskToWeeklyLogInputBody 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public migrateTaskToWeeklyLog(id: number, migrateTaskToWeeklyLogInputBody: MigrateTaskToWeeklyLogInputBody, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public migrateTaskToWeeklyLog(id: number, migrateTaskToWeeklyLogInputBody: MigrateTaskToWeeklyLogInputBody, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public migrateTaskToWeeklyLog(id: number, migrateTaskToWeeklyLogInputBody: MigrateTaskToWeeklyLogInputBody, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public migrateTaskToWeeklyLog(id: number, migrateTaskToWeeklyLogInputBody: MigrateTaskToWeeklyLogInputBody, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling migrateTaskToWeeklyLog.');
        }
        if (migrateTaskToWeeklyLogInputBody === null || migrateTaskToWeeklyLogInputBody === undefined) {
            throw new Error('Required parameter migrateTaskToWeeklyLogInputBody was null or undefined when calling migrateTaskToWeeklyLog.');
        }
        ...
        let localVarPath = `/api/tasks/${this.configuration.encodeParam({name: "id", value: id, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64"})}/migrateToWeekly`;
        return this.httpClient.request<any>('patch', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: migrateTaskToWeeklyLogInputBody,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: localVarHeaders,
                observe: observe,
