...
export class TaskService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public migrateTaskToWeeklyLog(id: number, migrateTaskToWeeklyLogInputBody: MigrateTaskToMonthlyLogInputBody, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public migrateTaskToWeeklyLog(id: number, migrateTaskToWeeklyLogInputBody: MigrateTaskToMonthlyLogInputBody, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public migrateTaskToWeeklyLog(id: number, migrateTaskToWeeklyLogInputBody: MigrateTaskToMonthlyLogInputBody, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public migrateTaskToWeeklyLog(id: number, migrateTaskToWeeklyLogInputBody: MigrateTaskToMonthlyLogInputBody, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (id === null || id === undefined) {
